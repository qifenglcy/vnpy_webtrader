...
# 使用成交记录 计算盈利
# @vnpyRouter.get("/calculate")
# def calculate():
#     fo = open("./tradeRecord.json", "r+")
#     line = json.loads(fo.read())
#     fo.close()
#     return line

# # 发送预警
# @vnpyRouter.get("/alert")
# def alert():
#     fo = open("./alert.json", "r+")
#     line = json.loads(fo.read())
#     fo.close()
#     return line
...
@vnpyRouter.post("/token", response_model=Token)
...
@vnpyRouter.post("/tick/{vt_symbol}")
...
@vnpyRouter.delete("/order/{vt_orderid}")
